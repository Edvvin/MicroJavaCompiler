...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(AstNeop AstNeop) { visit(); }
    ...
    public void visit(AstCondFactExpr AstCondFactExpr) { visit(); }
    ...
    public void visit(AstDesigFact AstDesigFact) { visit(); }
    ...
    public void visit(AstSwitchBegin AstSwitchBegin) { visit(); }
    public void visit(AstMinus AstMinus) { visit(); }
    ...
    public void visit(AstYieldBegin AstYieldBegin) { visit(); }
    public void visit(AstDefault AstDefault) { visit(); }
    public void visit(AstCase AstCase) { visit(); }
    public void visit(AstDefaultBegin AstDefaultBegin) { visit(); }
    ...
    public void visit(AstIfPartErr AstIfPartErr) { visit(); }
