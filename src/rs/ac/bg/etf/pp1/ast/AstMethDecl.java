...
public class AstMethDecl extends MethodDecl {
    ...
    public AstMethDecl (MethodTypeName MethodTypeName, FormalParams FormalParams, VarDeclList VarDeclList, StatementList StatementList) {
